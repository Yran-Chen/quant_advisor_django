...
class FactorDatabase(Database):
    ...
    def get_alpha_df(self, alpha_id, table_name='fut_alpha', start_date=None, end_date=None,
...
#     print(fb.get_op_param_df(op_id='op_11'))
    ...
    # df = pd.read_csv('..\\alpha_data\\alpha_param_df.csv')
    # print(df)
    # df.columns = [i.replace('-','_') for i in df.columns]
    # fb.add_data('fut_alpha_param',df,if_new_col=True)
